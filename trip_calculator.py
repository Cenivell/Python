...
# (тобто може бути як 15б так і 20 км), тому цю величину ми будемо рандомізувати для більшої точності наших обрахунків.
...
# 2) Розрахунок та вивід у консоль короткого звіту по кожному дню, що відображатиме: кількість пройдених км, кількість/вага продуктів, що залишилася та
# зміну ваги продуктів з розподілом на кожного учасника походу. 
